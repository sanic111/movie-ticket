        ...
        <div className="purchase-page">
            ...
            <SectionWrapper>
                <ul className="note-list">
                    ...
                    <li>
                        Nếu không nhận được mã vé sau 30 phút kể từ thời điểm hoàn tất thanh toán, vui lòng liên hệ tổng
                        đài CSKH *6789 để hỗ trợ.
                    </li>
                    <li>
                        Rạp phim không được phép phục vụ khách hàng dưới 13 tuổi cho các suất chiếu sau 22:00 và 16 tuổi
                        cho các suất chiếu kết thúc sau 23:00
                    </li>
                </ul>
            </SectionWrapper>
            <SectionWrapper>
